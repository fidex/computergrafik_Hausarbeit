...
void Test1::vector()
{
    ...
    {
        Vector vr( (float)(random()%10000)-5000.0f, (float)(random()%10000)-5000.0f, float(random()%10000)-5000.0f  );
    ...
    
    {
        ...
        {
            float z= float(random()%2000)-1000.0f;
            if( z==0) z+=1.0f;
            Vector o( (float)(random()%2000)-1000.0f, (float)(random()%2000)-1000.0f, z );
            o = o*0.01f;
            
            Vector dest( (float)(random()%2000)-1000.0f, (float)(random()%2000)-1000.0f, 0 );
            dest = dest*0.001f;
    ...
    }
    {
        ...
        for( int i=0; i<20000; i++)
        {
            float y= float(random()%2000)-1000.0f;
            if( y==0) y+=1.0f;
            Vector o( (float)(random()%2000)-1000.0f, y, (float)(random()%2000)-1000.0f );
            o = o*0.01f;
            
            Vector dest( (float)(random()%2000)-1000.0f, 0, (float)(random()%2000)-1000.0f );
            dest = dest*0.001f;
    ...
    
    {
        ...
        for( int i=0; i<20000; i++)
        {
            float x= float(random()%2000)-1000.0f;
            if( x==0) x+=1.0f;
            Vector o( x, (float)(random()%4000)-2000.0f, (float)(random()%4000)-2000.0f );
            o = o*0.01f;
            
            Vector dest( 0, (float)(random()%2000), (float)(random()%2000) );
            dest = dest*0.001f;
